...
$( document ).ready(function() {
    ...
    loadSources();
      ...
      // var map;
      // var theCenter = {lat: 0, lng: 0};

 //      function initMap() {
 //        console.log("initMap() called")
 //        map = new google.maps.Map(document.getElementById('feed-area'), {
 //          center: theCenter,
 //          zoom: 2,
 //          mapTypeId: 'terrain'
 //        });
 //        var bbcInfoWin = new google.maps.InfoWindow({
 //   content: '<a href="#" onclick="loadArticles(\'bbc-news\')">'">Articles from BBC</a>'
 // });
 //        var markerBBC = new google.maps.Marker({position: {lat: 51.507351, lng: -0.127758}, map: map});
 //
 //        markerBBC.addListener('click', function() {
 //          bbcInfoWin.open(map, markerBBC);
 //        })
 //      }
